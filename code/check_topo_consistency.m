...
% Verify the Supplementary Table S1 "topographic consistency (Fisher-z LOO)" rows for Water vs Clay.
...
fprintf('\n=== Supplementary Table S1 topographic consistency (Fisher-z LOO), Water vs Clay ===\n');
...
% (deterministic, no RNG). Matches the exact permutation reported in Supplementary Table S1.
